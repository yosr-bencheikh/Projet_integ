                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Gestion de stages</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Bienvenue à la gestion des stages!👋</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                            ...
                            <button class="btn custom-button d-grid w-100">Se connecter</button>
                        </form>
